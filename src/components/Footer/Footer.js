          ...
          <div className={css.links}>
            ...
            <div className={css.infoLinks}>
              <ul className={css.list}>
                ...
                <li className={css.listItem}>
                  <NamedLink name="Businesses" className={css.link}>
                    <FormattedMessage id="Footer.businesses" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink name="JaegerFAQPage" className={css.link}>
              ...
              <ul className={css.list}>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchInsideSales" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchOutsideSales" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchSalesSupport" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchClientServices" />
                  </NamedLink>
                </li>
              </ul>
            </div>
              ...
              <ul className={css.list}>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchLeadGeneration" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchBusinessDevelopment" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchAccountManager" />
                  </NamedLink>
                </li>
              </ul>
            </div>
